package com.ntuzy.hadoop.mapreduce.grouping;
...
public class CustomGroupingMain extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        fields[0] = "hdfs://node01:8020/tmall-201412-test.csv";
        fields[1] = "hdfs://node01:8020/sort2";
        int exitCode = ToolRunner.run(new CustomGroupingMain(), fields);
